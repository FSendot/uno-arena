...
- Pod scheduling is asynchronous to `CreateRoom`. Admission backlog is visible as `room_starting`; tournament assignment waits for Ready, and clients retry with bounded backoff rather than holding creation transactions open.
