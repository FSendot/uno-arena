...
| A disposable empty `kind` cluster is the canonical local deployment-acceptance environment; Compose and offline renders are preflight evidence only | `01-context-and-container-view.md`, `06-cross-cutting-concerns.md`, `infrastructure/kind/README.md`, `docs/adr/0045-kind-as-empty-cluster-deployment-acceptance.md` |
