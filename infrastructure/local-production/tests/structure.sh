...
grep -Fq 'docker update --cpus 4 "${LOCAL_PRODUCTION_CLUSTER}-control-plane"' "${LOCAL}/bin/create-cluster.sh"
grep -Fq 'docker update --cpus 2 "${LOCAL_PRODUCTION_CLUSTER}-worker"' "${LOCAL}/bin/create-cluster.sh"
grep -Fq 'docker update --cpus 2 "${LOCAL_PRODUCTION_CLUSTER}-worker2"' "${LOCAL}/bin/create-cluster.sh"
