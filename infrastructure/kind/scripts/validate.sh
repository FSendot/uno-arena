...
bash -n "${SCRIPT_DIR}/build-load-services.sh"
bash -n "${SCRIPT_DIR}/deploy-game-integrity.sh"
...
bash -n "${SCRIPT_DIR}/load-debezium-server.sh"
bash -n "${SCRIPT_DIR}/status-debezium-server.sh"
bash -n "${SCRIPT_DIR}/test-debezium-server-structure.sh"
bash -n "${SCRIPT_DIR}/load-debezium-connect.sh"
bash -n "${SCRIPT_DIR}/test-debezium-connectors.sh"
bash -n "${SCRIPT_DIR}/test-debezium-connect-structure.sh"
bash -n "${SCRIPT_DIR}/test-analytics-kafka-consumer-structure.sh"
bash -n "${SCRIPT_DIR}/test-analytics-kafka-to-clickhouse-live.sh"
bash -n "${SCRIPT_DIR}/test-analytics-projection-rebuilder-structure.sh"
bash -n "${SCRIPT_DIR}/test-analytics-projection-rebuilder-live.sh"
bash -n "${SCRIPT_DIR}/test-spectator-projection-rebuilder-live.sh"
"${SCRIPT_DIR}/test-identity-integration-structure.sh"
"${SCRIPT_DIR}/test-redis-aof-structure.sh"
"${SCRIPT_DIR}/test-debezium-server-structure.sh"
"${SCRIPT_DIR}/test-debezium-connect-structure.sh"
"${SCRIPT_DIR}/test-analytics-kafka-consumer-structure.sh"
"${SCRIPT_DIR}/test-analytics-projection-rebuilder-structure.sh"
"${SCRIPT_DIR}/test-clean-deployment-structure.sh"
