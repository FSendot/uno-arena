...
// FactName identifies a named domain fact emitted by an accepted projection transition.
type FactName string

const (
	FactSpectatorRoomProjectionUpdated FactName = "SpectatorRoomProjectionUpdated"
	FactSpectatorEventDropped          FactName = "SpectatorEventDropped"
	FactProjectionEventQuarantined     FactName = "ProjectionEventQuarantined"
	FactStreamClose                    FactName = "StreamClose"
)
