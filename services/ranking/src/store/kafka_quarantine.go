...
func (s *RankingStore) IsKafkaAggregateQuarantined(ctx context.Context, consumerGroup, sourceTopic, aggregateKey string) (bool, error) {
	if s == nil || s.pool == nil {
...
func (s *RankingStore) QuarantineKafkaAggregate(ctx context.Context, rec KafkaAggregateQuarantine) error {
	if s == nil || s.pool == nil {
