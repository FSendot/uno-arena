...
const (
	...
	ExpectedSchemaChecksum = "b71838545d5710c6844caeced955781bbfd00b3568579a7e05dec72c52f27442"
)
...
// overridden by RANKING_SCHEMA_CHECKSUM / RANKING_SCHEMA_VERSION env.
func DefaultSchemaExpectation() SchemaExpectation {
	...
	if v := strings.TrimSpace(os.Getenv("RANKING_SCHEMA_VERSION")); v != "" {
		exp.MigrationVersion = v
		exp.BootstrapVersion = v
	}
	if c := strings.TrimSpace(os.Getenv("RANKING_SCHEMA_CHECKSUM")); c != "" {
